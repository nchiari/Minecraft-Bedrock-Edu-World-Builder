...
- Takes one or more `.mcpack` / `.mcaddon` files, pack folders, or a folder containing multiple packs. Behavior Pack and Resource Pack folders can also be selected separately.
...
2. Choose your `.mcpack` / `.mcaddon` files, a general pack folder, separate BP/RP folders, or any combination of them.
